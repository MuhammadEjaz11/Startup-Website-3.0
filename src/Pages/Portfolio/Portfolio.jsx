...
const Portfolio = () => {
  ...
  const initialMobileApps = [
    {
      img: stat1,
      title: "Gym App",
      description: "Mobile app for gym management.",
      readmore: "read more",
    },
    {
      img: stat2,
    ...
    },
    {
      ...
      description: "Workout planning mobile app.",
      readmore: "read more",
    },
    {
      img: stat4,
    ...
    },
    {
      img: stat5,
      title: "Fitness Blog",
      description: "Web blog for fitness and health.",
      readmore: "read more",
    },
    {
      img: stat6,
      title: "Nutrition Tracker",
      description: "Web-based nutrition tracking app.",
      readmore: "read more",
    },
  ];
  ...
  const initialWebDevelopment = [
    {
      img: web1,
      title: "Web Design",
      description: "Web platform for Beauty.",
      readmore: "read more",
    },
    {
      img: web2,
      title: "Book Store",
      description: "Web blog for Book Store.",
      readmore: "read more",
    },
    {
      img: web3,
      title: "Dahlia",
      description: "Web Platform for Dahlia.",
      readmore: "read more",
    },
    {
      img: web4,
      title: "White Tail",
      description: "Web platform for WhiteTail.",
      readmore: "read more",
    },
    {
      img: web5,
      title: "Intrment Buy",
      description: "Web app for Instrument Buy.",
      readmore: "read more",
    },
    {
      img: web6,
      title: "Book Search",
      description: "Web Platform for Book Search.",
      readmore: "read more",
    },
  ];
  ...
  const initialLogoDesign = [
    ...
    },
    {
      img: logo2,
      title: "Chat Cat",
      description: "chat cat logo design.",
      readmore: "read more",
    },
    {
      img: logo3,
      title: "ShopHappy",
      description: "Shop Happy logo design.",
      readmore: "read more",
    },
    {
      img: logo4,
      title: "Fresh Lemon",
      description: "Fresh Lemon logo design.",
      readmore: "read more",
    },
    {
      img: logo5,
      title: "Wood Lake",
      description: "Wood Lake logo design.",
      readmore: "read more",
    },
    {
      img: logo6,
      title: "Gobel Bag",
      description: "Gobel Bag logo design.",
      readmore: "read more",
    },
  ];
  ...
  const initialVideoEditing = [
    {
      img: vid1,
      title: "Workout Video",
      description: "Video editing for workout series.",
      readmore: "read more",
    },
    {
      img: vid2,
      title: "Fitness Tips",
      description: "Video editing for fitness tutorials.",
      readmore: "read more",
    },
    {
      img: vid3,
      title: "Gym Promo",
      description: "Promo video editing for gym.",
      readmore: "read more",
    },
    {
      img: vid4,
    ...
    },
    {
      img: vid5,
      title: "Gym Web",
      description: "Web platform for gym management.",
      readmore: "read more",
    },
    {
      img: vid6,
    ...
    webDevelopment: [
      {
        ...
        description: "Web Platform for Clothing Brand.",
        readmore: "read more",
      },
      {
        img: web8,
        title: "Decoration",
        description: "Web Platform for Decoration.",
        readmore: "read more",
      },
      {
        img: web9,
        title: "Travel Agency",
        description: "Web Platform for Travel Agency.",
        readmore: "read more",
      },
    ],
    logoDesign: [
      {
        img: logo7,
        title: "Food Spot",
        description: "Food Spot.",
        readmore: "read more",
      },
      {
        img: logo8,
        title: "Gym Web",
        description: "Web platform logo design",
        readmore: "read more",
      },
      {
        img: logo9,
        title: "Gym App",
        description: "Mobile app logo design.",
        readmore: "read more",
      },
    ],
    videoEditing: [
  ...
  const handleLoadMore = () => {
    ...
    switch (currentTab) {
      case "mobileApps":
        setMobileApps((prevContent) => [
          ...prevContent,
          ...additionalContent.mobileApps,
        ]);
        break;
      case "webDevelopment":
        setWebDevelopment((prevContent) => [
          ...prevContent,
          ...additionalContent.webDevelopment,
        ]);
        break;
      case "logoDesign":
        setLogoDesign((prevContent) => [
          ...prevContent,
          ...additionalContent.logoDesign,
        ]);
        break;
      case "videoEditing":
        setVideoEditing((prevContent) => [
          ...prevContent,
          ...additionalContent.videoEditing,
        ]);
        break;
      case "digitalMarketing":
        setDigitalMarketing((prevContent) => [
          ...prevContent,
          ...additionalContent.initialDigital,
        ]);
      default:
        break;
    }
